...
class Viddler_V2 {
  ...
  $array = $__api->viddler_users_getProfile(array("user"=>"phpfunk"));
    ...
    $viddler->viddler_users_auth();
		...
		$post_methods = array ('viddler.encoding.cancel', 'viddler.encoding.encode', 'viddler.encoding.setOptions', 'viddler.groups.addVideo', 'viddler.groups.join', 'viddler.groups.leave', 'viddler.groups.removeVideo', 'viddler.playlists.addVideo', 'viddler.playlists.create', 'viddler.playlists.delete', 'viddler.playlists.removeVideo', 'viddler.playlists.moveVideo', 'viddler.playslists.setDetails', 'viddler.users.setSettings', 'viddler.users.setProfile', 'viddler.users.setOptions', 'viddler.users.acceptFriendRequest', 'viddler.users.ignoreFriendRequest', 'viddler.users.sendFriendRequest', 'viddler.users.subscribe', 'viddler.users.unsubscribe', 'viddler.videos.setDetails', 'viddler.videos.setPermalink', 'viddler.videos.comments.add', 'viddler.videos.comments.remove', 'viddler.videos.upload', 'viddler.videos.delete', 'viddler.videos.delFile', 'viddler.videos.favorite', 'viddler.videos.unfavorite', 'viddler.videos.setPermalink', 'viddler.videos.setThumbnail', 'viddler.videos.setDetails', 'viddler.videos.enableAds', 'viddler.videos.disableAds' );
