...
class getID3 {
	...
	function getID3() {
		...
		if (GETID3_OS_ISWINDOWS && ! defined ( 'GETID3_HELPERAPPSDIR' )) {
			...
			$helperappsdir = GETID3_INCLUDEPATH . '..' . DIRECTORY_SEPARATOR . 'getid3helperapps'; // must not have any space in this path
			...
			*/
			...
			define ( 'GETID3_HELPERAPPSDIR', $this->getShortPathName ( realpath ( $helperappsdir ) ) . DIRECTORY_SEPARATOR );
		}
	
	}
	
	function getShortPathName($file) {
		exec ( ('FOR %A IN ("' . $file . '") DO ECHO.%~sfA'), $output );
		return $output [2];
	}
	...
	function GetFileFormatArray() {
		...
		if (empty ( $format_info )) {
			...
			'adif' => array ('pattern' => '^ADIF', 'group' => 'audio', 'module' => 'aac', 'option' => 'adif', 'mime_type' => 'application/octet-stream', 'fail_ape' => 'WARNING' ), 

			// AAC  - audio       - Advanced Audio Coding (AAC) - ADTS format (very similar to MP3)
			'adts' => array ('pattern' => '^\xFF[\xF0-\xF1\xF8-\xF9]', 'group' => 'audio', 'module' => 'aac', 'option' => 'adts', 'mime_type' => 'application/octet-stream', 'fail_ape' => 'WARNING' ), 
			...
			'dss' => array ('pattern' => '^[\x02]dss', 'group' => 'audio', 'module' => 'dss', 'mime_type' => 'application/octet-stream' ), 

			// DTS  - audio       - Dolby Theatre System
			'dts' => array ('pattern' => '^\x7F\xFE\x80\x01', 'group' => 'audio', 'module' => 'dts', 'mime_type' => 'audio/dts' ), 

			// FLAC - audio       - Free Lossless Audio Codec
			'flac' => array ('pattern' => '^fLaC', 'group' => 'audio', 'module' => 'flac', 'mime_type' => 'audio/x-flac' ), 
			...
			'mac' => array ('pattern' => '^MAC ', 'group' => 'audio', 'module' => 'monkey', 'mime_type' => 'application/octet-stream' ), 
			...
			'it' => array ('pattern' => '^IMPM', 'group' => 'audio', 'module' => 'mod', 'option' => 'it', 'mime_type' => 'audio/it' ), 

			// MOD  - audio       - MODule (eXtended Module, various sub-formats)
			'xm' => array ('pattern' => '^Extended Module', 'group' => 'audio', 'module' => 'mod', 'option' => 'xm', 'mime_type' => 'audio/xm' ), 

			// MOD  - audio       - MODule (ScreamTracker)
			's3m' => array ('pattern' => '^.{44}SCRM', 'group' => 'audio', 'module' => 'mod', 'option' => 's3m', 'mime_type' => 'audio/s3m' ), 

			// MPC  - audio       - Musepack / MPEGplus
			'mpc' => array ('pattern' => '^(MPCK|MP\+|[\x00\x01\x10\x11\x40\x41\x50\x51\x80\x81\x90\x91\xC0\xC1\xD0\xD1][\x20-37][\x00\x20\x40\x60\x80\xA0\xC0\xE0])', 'group' => 'audio', 'module' => 'mpc', 'mime_type' => 'audio/x-musepack' ), 

			// MP3  - audio       - MPEG-audio Layer 3 (very similar to AAC-ADTS)
			'mp3' => array ('pattern' => '^\xFF[\xE2-\xE7\xF2-\xF7\xFA-\xFF][\x00-\xEB]', 'group' => 'audio', 'module' => 'mp3', 'mime_type' => 'audio/mpeg' ), 
...
'group' => 'audio', 'module' => 'tta', 'mime_type' => 'application/octet-stream' ), 
			...
			'mpeg' => array ('pattern' => '^\x00\x00\x01(\xBA|\xB3)', 'group' => 'audio-video', 'module' => 'mpeg', 'mime_type' => 'video/mpeg' ), 
			...
			'riff' => array ('pattern' => '^(RIFF|SDSS|FORM)', 'group' => 'audio-video', 'module' => 'riff', 'mime_type' => 'audio/x-wave', 'fail_ape' => 'WARNING' ), 
			...
			'svg' => array ('pattern' => '<!DOCTYPE svg PUBLIC ', 'group' => 'graphic', 'module' => 'svg', 'mime_type' => 'image/svg+xml', 'fail_id3' => 'ERROR', 'fail_ape' => 'ERROR' ), 
			...
			'gz' => array ('pattern' => '^\x1F\x8B\x08', 'group' => 'archive', 'module' => 'gzip', 'mime_type' => 'application/x-gzip', 'fail_id3' => 'ERROR', 'fail_ape' => 'ERROR' ), 
			...
			'msoffice' => array ('pattern' => '^\xD0\xCF\x11\xE0', // D0CF11E == DOCFILE == Microsoft Office Document
...
'ape' => array ('ape', 'UTF-8' ), 'cue' => array ('cue', 'ISO-8859-1' ) );
		}
